            ...
            <div class="col lg-12-md-12 stretch-card grid-margin ">
                <div class="card bg-gradient card-img-holder text-black">
                  <div class="card-body div-hover" class="div-hover" style="display: flex;justify-content: space-between;padding: 15px;">
                    <div style="display: flex;justify-content: space-between;padding: 1px;"onclick="redirectToDetails(<?php echo $row['id_sous']; ?>)" >
                    ...
                    <div col-md-12>
                        ...
                        <div class="btn-group ">
                        <h5 class="" class="click" ><?=$row['nom']." ".$row['prenom']?> a publié un nouveau support de cours &nbsp;: <?=$row['titre_sous']?>&nbsp; 
